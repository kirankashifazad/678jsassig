...
var u_num = +prompt("enter urdu num")
var m_num = +prompt("enter math num")
var res = (e_num + m_num + u_num)
alert(res)
var t_mark = 300
var percentage = (res / t_mark) * 100
document.write(" eng num =", e_num, "&nbsp", "&nbsp", "&nbsp", "total num =", 100, "&nbsp", "&nbsp", "&nbsp", "percentage =", e_num / 100 * 100, "<br>")
document.write(" urdu num =", u_num, "&nbsp", "&nbsp", "&nbsp", "total num =", 100, "&nbsp", "&nbsp", "&nbsp", "percentage =", u_num / 100 * 100, "<br>")
document.write(" math num =", m_num, "&nbsp", "&nbsp", "&nbsp", "total num =", 100, "&nbsp", "&nbsp", "&nbsp", "percentage =", m_num / 100 * 100, "<br>")

document.write(e_num + m_num + u_num, "&nbsp", "&nbsp", "&nbsp", "&nbsp", "&nbsp", "&nbsp", 300, "&nbsp", "&nbsp", "&nbsp", "&nbsp", "&nbsp", "&nbsp", res / t_mark * 100)
...
//    var userInput = prompt("enter number upper case  or lower case")
//    if ( userInput ==  65 )
//        alert("is an upper case A")

//    else if (userInput == 90 )
//    alert("is an upper case Z")

  
//    else if (userInput == 97 )
//    alert("is an lower case a")


//    else if (userInput == 122 )
//    alert("is an lower case z")
...
var userPassword  = +prompt("enteryour password")
   if (userPassword == ""){
    document.write("please enter your password")
   }
